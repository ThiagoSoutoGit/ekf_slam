...
class LandmarksMap(genpy.Message):
  _md5sum = "be59b8991d90b2ec01f312b7f555e888"
...
string frame_id
"""
  __slots__ = ['header','x','y','size','id','map']
  _slot_types = ['std_msgs/Header','float64[]','float64[]','float64[]','int64[]','int64[]']

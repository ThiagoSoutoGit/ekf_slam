...
class PlatformGoalGoal(genpy.Message):
  _md5sum = "77c63f6dc8fbd38f42f7e290bcee2595"
...
"""
  ...
  __slots__ = ['target_pose','link_id','command']
  _slot_types = ['geometry_msgs/PoseStamped','std_msgs/String','uint8']
